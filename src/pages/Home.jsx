      ...
      <section className="py-16 px-4 bg-cream">
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-3 gap-3 rounded-2xl overflow-hidden">
            <img src="https://media.base44.com/images/public/69e9180b18cbe750b3daf184/c8ad32d8d_generated_image.png" alt="Florida condo" className="mx-4 col-span-2 h-64 w-full object-cover" />
