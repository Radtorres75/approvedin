    ...
    <div className="min-h-screen bg-cream font-inter">
      ...
      <section className="bg-navy text-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-[hsl(var(--card))] mb-10 mx-auto text-lg leading-relaxed sm:text-xl max-w-2xl">Eaautomatically tracks vendor COIs, trade licenses, and corporate filings for Florida community associations — so you never have to chase paperwork again
