      ...
      <form onSubmit={handleVerify} className="space-y-4">
        <div>
          ...
          <input
            ...
            required
            placeholder="123456"
            className="w-full border border-sand-dark rounded-lg px-4 py-3 text-navy text-sm text-center tracking-widest text-lg font-bold focus:outline-none focus:ring-2 focus:ring-teal/30 focus:border-teal bg-white"
          />
        </div>
        <button
          type="submit"
